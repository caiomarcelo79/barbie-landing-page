...
if (window.innerWidth <= 1259 && window.innerWidth >= 601) {
...
if (window.innerWidth <= 600) {
  ...
  '<div>        <img src="imgs/logo.png" alt="Logo PlayCube">        <a href="#">Sobre</a>        <a href="#">Contato</a>        <a href="#">Suporte</a>        <a href="#">Adicione um Filme</a>        <a href="#">Adicione uma Série</a>        <a href="#">Discussões</a>        <a href="#">Termos de Uso</a>        <a href="#">Política de Privacidade</a>        <a href="#">Diretrizes</a>      </div>'
}
